...
<head>
    ...
    <style>
        * {
        ...
        /* Scrollable sidebar - FIXED VERSION (same as admin) */
        .sidebar-scroll {
        ...
        /* Mobile Responsive - Same as admin */
...
<body class="min-h-screen">
    ...
    <!-- Desktop Sidebar -->
    <div class="sidebar hidden md:block w-64 min-h-screen fixed left-0 top-0 z-40">
        <div class="sidebar-container">
            ...
            <div class="sidebar-scroll px-4 py-2">
                <nav class="space-y-2">
                    <a href="?module=dashboard" class="sidebar-link flex items-center p-3 rounded-lg text-white <?php echo $current_module == 'dashboard' ? 'active' : ''; ?>">
                        <i class="fas fa-home mr-3 text-lg"></i>
                        <span class="font-medium">Dashboard</span>
                    </a>
                    
                    <a href="?module=new-report" class="sidebar-link flex items-center p-3 rounded-lg text-white <?php echo $current_module == 'new-report' ? 'active' : ''; ?>">
                    ...
                    <a href="?module=my-reports" class="sidebar-link flex items-center p-3 rounded-lg text-white <?php echo $current_module == 'my-reports' ? 'active' : ''; ?>">
                    ...
                    <a href="?module=announcements" class="sidebar-link flex items-center p-3 rounded-lg text-white <?php echo $current_module == 'announcements' ? 'active' : ''; ?>">
                    ...
                    <a href="?module=profile" class="sidebar-link flex items-center p-3 rounded-lg text-white <?php echo $current_module == 'profile' ? 'active' : ''; ?>">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            <h1 class="text-2xl font-bold text-gray-800">
                                <?php echo getModuleTitle($current_module); ?>
                            </h1>
                            ...
                            <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-xl border z-40">
                                <div class="p-4 border-b">
                                    <div class="flex items-center space-x-3 mb-2">
                                        <?php if (!empty($_SESSION['profile_picture'] ?? $profile_picture) && file_exists($full_path)): ?>
