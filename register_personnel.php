    ...
    <style>
        * {
        ...
        .role-icon {
            ...
            color: white;
            font-size: 18px;
            background: #667eea; /* Changed from gradient to solid blue */
        }
        ...
        /* Role colors - Changed to all blue */
        .tanod-role .role-icon { background: #667eea; }
        .secretary-role .role-icon { background: #667eea; }
        .admin-role .role-icon { background: #667eea; }
        .captain-role .role-icon { background: #667eea; }
        .lupon-role .role-icon { background: #667eea; }
        .super-admin-role .role-icon { background: #667eea; }
