...
<head>
    ...
    <style>
        * {
        ...
        /* Role-specific styling - CHANGED TO BLUE GRADIENTS */
        .role-option {
            display: flex;
            align-items: center;
            padding: 15px;
        ...
        /* Role colors - CHANGED TO BLUE GRADIENTS */
        .tanod-role { background: linear-gradient(135deg, #4299e1, #3182ce); }
        .secretary-role { background: linear-gradient(135deg, #63b3ed, #4299e1); }
        .admin-role { background: linear-gradient(135deg, #3182ce, #2c5282); }
        .captain-role { background: linear-gradient(135deg, #2b6cb0, #2c5282); }
        .lupon-role { background: linear-gradient(135deg, #90cdf4, #63b3ed); }
        .super-admin-role { background: linear-gradient(135deg, #2d3748, #4a5568); }
