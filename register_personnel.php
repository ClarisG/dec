              ...
              $insert_query = "INSERT INTO users (
                ...
                if ($insert_stmt->execute()) {
                    ...
                    if ($reg_stmt->execute()) {
                        ...
                        $success = "{$role_titles[$role]} registration successful! Your 4-digit Master Code is: <strong style='font-size: 24px; color: #1a4f8c;'>{$master_code}</strong><br><br>";
    ...
    <style>
        * {
        ...
        @media (min-width: 768px) {
            ...
            /* Wave Effect - Matching register.php */
            .left-section::after {
                content: '';
                position: absolute;
                top: 0;
        ...
        .tanod-role { background: linear-gradient(135deg, #1e3a8a, #1e40af); }
        .secretary-role { background: linear-gradient(135deg, #1e40af, #1d4ed8); }
        .admin-role { background: linear-gradient(135deg, #1d4ed8, #3b82f6); }
        .captain-role { background: linear-gradient(135deg, #3b82f6, #60a5fa); }
        .lupon-role { background: linear-gradient(135deg, #60a5fa, #93c5fd); }
        .super-admin-role { background: linear-gradient(135deg, #93c5fd, #bfdbfe); }
